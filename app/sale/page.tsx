...
export default function SalePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="mb-8 text-3xl font-light tracking-wide md:text-4xl">Sale Items</h1>
      ...
      {loading ? (
        ...
        <div className="py-12 text-center">
          <p className="text-lg text-neutral-600">No sale products found at the moment.</p>
